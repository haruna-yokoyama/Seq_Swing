...
public class EventThread extends Thread {
	...
	private void methodEntryEvent(MethodEntryEvent event) {
		...
		// クラス名,返り値の型,メソッド名,引数の型,変数(変数の型)
		writeCSV("\n");
		writeCSV(event.getClass().getSimpleName() + ","	+ event.method().returnTypeName() + "," + event.method().name()	+ "," + event.method().argumentTypeNames() + ",");
	}
