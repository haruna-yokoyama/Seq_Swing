...
public final class Trace {
   ...
   public Trace (final String[] args) {
      ...
      System.err.println("  Requires Internet to access Sun's tools.jar files.");
      System.err.println("  Requires class file (compiling with -g gives more info) in current directory.");
      ...
      if (vm instanceof PathSearchingVirtualMachine) {
         System.err.println ("Virtual machine's class path = " + ((PathSearchingVirtualMachine)vm).classPath());
      }
   ...
   private static LaunchingConnector findLaunchingConnector() {
      // System.err.println (Bootstrap.virtualMachineManager().launchingConnectors().toString());
    ...
    */
   private static Map<String,Connector.Argument> connectorArguments (final LaunchingConnector connector, final String mainArgs) {
   ...
   public static void usage() {
      ...
      System.err.println ("<class> is the program (class file) to trace; must be in current directory");
